...
async function initDatabase() {
    ...
    try {
        ...
        const { error: apiKeysTableError } = await supabase.rpc('create_api_keys_table');
        ...
        const { error: usageRecordsTableError } = await supabase.rpc('create_usage_records_table');
        ...
        const { error: tasksTableError } = await supabase.rpc('create_tasks_table');
        if (tasksTableError) {
        ...
        const { error: performanceMetricsTableError } = await supabase.rpc('create_performance_metrics_table');
        ...
        const { error: cacheTableError } = await supabase.rpc('create_cache_table');
        if (cacheTableError) {
        ...
        const { error: logsTableError } = await supabase.rpc('create_logs_table');
        if (logsTableError) {
        ...
        const { error: subscriptionsTableError } = await supabase.rpc('create_subscriptions_table');
        ...
        const { error: invoicesTableError } = await supabase.rpc('create_invoices_table');
        ...
        const { error: notificationsTableError } = await supabase.rpc('create_notifications_table');
        ...
        const { error: systemConfigTableError } = await supabase.rpc('create_system_config_table');
        ...
        const { error: aiModelsTableError } = await supabase.rpc('create_ai_models_table');
        ...
        const { error: aiProvidersTableError } = await supabase.rpc('create_ai_providers_table');
        ...
        const { error: routingConfigTableError } = await supabase.rpc('create_routing_config_table');
        ...
        const { error: routingHistoryTableError } = await supabase.rpc('create_routing_history_table');
        ...
        const { error: systemConfigInsertError } = await supabase.rpc('insert_initial_system_config');
        ...
        const { error: aiModelsInsertError } = await supabase.rpc('insert_initial_ai_models');
        ...
        const { error: aiProvidersInsertError } = await supabase.rpc('insert_initial_ai_providers');
        ...
        const { error: routingConfigInsertError } = await supabase.rpc('insert_initial_routing_config');
