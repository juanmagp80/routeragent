...
exports.markAllNotificationsAsRead = exports.markNotificationAsRead = exports.getNotifications = exports.testNotificationPaymentSuccess = exports.testNotificationWelcome = exports.testNotificationUsageAlert = exports.testNotificationApiKeyCreated = exports.validateDiscordWebhook = exports.validateSlackWebhook = exports.updateUserNotificationsDev = exports.updateCurrentUserDev = exports.getCurrentUserDev = exports.createCheckoutSessionDev = exports.getBillingDev = exports.getMetricsDev = exports.deleteApiKeyDev = exports.createApiKeyDev = exports.listApiKeysDev = exports.deleteApiKey = exports.validateApiKey = exports.getApiKeyStats = exports.deactivateApiKey = exports.listApiKeys = exports.createApiKey = void 0;
...
exports.listApiKeysDev = listApiKeysDev;
const createApiKeyDev = async (req, res) => {
    try {
        ...
        const maxKeys = keyLimits[plan] || 1;
        ...
        res.status(201).json({
            api_key: {
                ...
                plan: data.plan,
                usage_limit: planLimits[plan] || 5000, // Límite total del plan
                usage_count: 0,
                is_active: true,
...
exports.createApiKeyDev = createApiKeyDev;
const deleteApiKeyDev = async (req, res) => {
    try {
        const { keyId } = req.params;
        const userId = '3a942f65-25e7-4de3-84cb-3df0268ff759'; // Usuario fijo para desarrollo
        if (!keyId) {
...
exports.deleteApiKeyDev = deleteApiKeyDev;
...
const getBillingDev = async (req, res) => {
    try {
        ...
        const currentPlanInfo = planLimits[currentPlan] || planLimits.free;
...
exports.getBillingDev = getBillingDev;
// Función temporal para crear sesión de checkout de Stripe (sin autenticación)
const createCheckoutSessionDev = async (req, res) => {
    try {
        ...
        const priceId = stripePrices[plan_id];
        if (!priceId) {
            return res.status(400).json({
...
exports.createCheckoutSessionDev = createCheckoutSessionDev;
// Función temporal para obtener información del usuario actual (sin autenticación)
const getCurrentUserDev = async (req, res) => {
    try {
...
exports.getCurrentUserDev = getCurrentUserDev;
const updateCurrentUserDev = async (req, res) => {
    try {
...
exports.updateCurrentUserDev = updateCurrentUserDev;
const updateUserNotificationsDev = async (req, res) => {
    try {
        ...
        if (slack_notifications !== undefined)
            updateData.slack_notifications = slack_notifications;
        if (discord_notifications !== undefined)
            updateData.discord_notifications = discord_notifications;
        if (slack_webhook_url !== undefined)
            updateData.slack_webhook_url = slack_webhook_url;
        if (discord_webhook_url !== undefined)
            updateData.discord_webhook_url = discord_webhook_url;
        const { data: updatedUser, error: updateError } = await supabase
            .from('users')
            .update(updateData)
...
exports.updateUserNotificationsDev = updateUserNotificationsDev;
// 🚫 SLACK DESHABILITADO TEMPORALMENTE
const validateSlackWebhook = async (req, res) => {
    try {
...
const validateDiscordWebhook = async (req, res) => {
    try {
...
exports.validateDiscordWebhook = validateDiscordWebhook;
// 🧪 ENDPOINTS DE PRUEBA PARA NOTIFICACIONES
const testNotificationApiKeyCreated = async (req, res) => {
    try {
...
exports.testNotificationApiKeyCreated = testNotificationApiKeyCreated;
const testNotificationUsageAlert = async (req, res) => {
    try {
...
exports.testNotificationUsageAlert = testNotificationUsageAlert;
const testNotificationWelcome = async (req, res) => {
    try {
...
exports.testNotificationWelcome = testNotificationWelcome;
const testNotificationPaymentSuccess = async (req, res) => {
    try {
...
exports.testNotificationPaymentSuccess = testNotificationPaymentSuccess;
