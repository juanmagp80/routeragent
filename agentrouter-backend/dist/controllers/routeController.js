...
exports.getMetrics = exports.clearCache = exports.getPerformanceStats = exports.routeTask = void 0;
...
const routeTask = async (req, res) => {
    try {
        ...
        try {
            ...
            if (req.apiKey) {
                await apiKeyService.incrementUsage(req.apiKey.id, result.cost, Math.ceil(task.input.length / 4), // tokens estimados
                result.selected_model, '/v1/route');
